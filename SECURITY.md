...
* Please create a draft security advisory on the Github page: the reporting form is under `> Security > Advisories`. The URL is https://github.com/exasol/azure-data-lake-storage-gen2-document-files-virtual-schema/security/advisories/new.
