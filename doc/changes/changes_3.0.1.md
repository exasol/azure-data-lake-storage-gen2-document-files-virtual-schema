# Virtual Schema for document data in files on Azure Data Lake Storage Gen 2 3.0.1, released 2026-06-11
...
### CVE-2026-41715 (CWE-200) in dependency `io.projectreactor.netty:reactor-netty-http:jar:1.2.16:compile`
io.projectreactor.netty : reactor-netty-http - Credential leak on protocol downgrade redirect
#### References
...
* #106: Fixed vulnerability CVE-2026-47244 in dependency `io.netty:netty-codec-http2:jar:4.2.13.Final:compile`
* #107: Fixed vulnerability CVE-2026-44249 in dependency `io.netty:netty-handler:jar:4.2.13.Final:compile`
* #108: Fixed vulnerability CVE-2026-45416 in dependency `io.netty:netty-handler:jar:4.2.13.Final:compile`
* #109: Fixed vulnerability CVE-2026-47691 in dependency `io.netty:netty-resolver-dns:jar:4.2.13.Final:compile`
* #110: Fixed vulnerability CVE-2026-45674 in dependency `io.netty:netty-resolver-dns:jar:4.2.13.Final:compile`
* #111: Fixed vulnerability CVE-2026-45673 in dependency `io.netty:netty-resolver-dns:jar:4.2.13.Final:compile`
* #112: Fixed vulnerability CVE-2026-45536 in dependency `io.netty:netty-transport-native-epoll:jar:4.2.13.Final:compile`
* #112: Fixed vulnerability CVE-2026-45536 in dependency `io.netty:netty-transport-native-kqueue:jar:4.2.13.Final:compile`
* #104: Fixed vulnerability CVE-2026-42587 in dependency `io.netty:netty-codec-http:jar:4.2.13.Final:compile`
* #113: Fixed vulnerability CVE-2026-48043 in dependency `io.netty:netty-codec-http2:jar:4.2.13.Final:compile`
* #114: Fixed vulnerability CVE-2026-50560 in dependency `io.netty:netty-codec-http2:jar:4.2.13.Final:compile`
* #115: Fixed vulnerability CVE-2026-41715 in dependency `io.projectreactor.netty:reactor-netty-http:jar:1.2.16:compile`
